...
l_dot_0     = -0.6785;       % Initial speed of spring compression, m/s
phi_dot_0   = 3.6775;       % Initial ang vel of spring, rad/s
l_0         = l0;       % Initial length of spring, m
phi_0       = -pi*3/32;    % Initial ang of spring (to vertical), rad
